...
public interface NearestDealerLocalService extends BaseLocalService, PersistedModelLocalService {
	 ...
	 * NearestDealerLocalServiceUtil} if injection and service tracking are not
	 * available.
	 */
