...
/**
 * The base model interface for the NearestDealer service. Represents a row in the &quot;Raybia_NearestDealer&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.liferay.raybia.dealer.model.impl.NearestDealerModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.liferay.raybia.dealer.model.impl.NearestDealerImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface NearestDealerModel
	extends BaseModel<NearestDealer>, GroupedModel, LocalizedModel,
			ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a nearest dealer model instance should use the {@link NearestDealer} interface instead.
	 */
