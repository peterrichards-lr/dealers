 ...
 * <code>com.liferay.raybia.dealer.service.impl.DealerLocalServiceImpl</code>
...
public class DealerLocalServiceUtil {
	 ...
	 */
	public static com.liferay.raybia.dealer.model.Dealer addDealer(com.liferay.raybia.dealer.model.Dealer dealer) {
	 ...
	 */
	public static com.liferay.raybia.dealer.model.Dealer createDealer(long dealerId) {
	 ...
	 */
	public static com.liferay.portal.kernel.model.PersistedModel createPersistedModel(
	 ...
	 * @throws PortalException
	 */
	public static com.liferay.raybia.dealer.model.Dealer deleteDealer(com.liferay.raybia.dealer.model.Dealer dealer)
			throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static com.liferay.raybia.dealer.model.Dealer fetchDealer(long dealerId) {
	 ...
	 *         not be found
	 */
	public static com.liferay.raybia.dealer.model.Dealer fetchDealerByUuidAndGroupId(String uuid, long groupId) {
	 ...
	 */
	public static com.liferay.raybia.dealer.model.Dealer getDealerByUuidAndGroupId(String uuid, long groupId)
			throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<com.liferay.raybia.dealer.model.Dealer> getDealers(int start, int end) {
	...
	public static java.util.List<com.liferay.raybia.dealer.model.Dealer> getDealersByGroupId(long groupId, int start,
			int end) {
	...
	public static java.util.List<com.liferay.raybia.dealer.model.Dealer> getDealersByGroupId(long groupId, int start,
		...
		return getService().getDealersByGroupId(groupId, start, end, orderByComparator);
	}
	 ...
	 */
	public static java.util.List<com.liferay.raybia.dealer.model.Dealer> getDealersByUuidAndCompanyId(String uuid,
			long companyId) {
	...
	public static java.util.List<com.liferay.raybia.dealer.model.Dealer> getDealersByUuidAndCompanyId(String uuid,
		...
		return getService().getDealersByUuidAndCompanyId(uuid, companyId, start, end, orderByComparator);
	}
	 ...
	 */
	public static com.liferay.raybia.dealer.model.Dealer updateDealer(com.liferay.raybia.dealer.model.Dealer dealer) {
	...
	private static ServiceTracker<DealerLocalService, DealerLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(DealerLocalService.class);

		ServiceTracker<DealerLocalService, DealerLocalService> serviceTracker = new ServiceTracker<DealerLocalService, DealerLocalService>(
