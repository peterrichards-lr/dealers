...
/**
 * Provides the local service interface for Dealer. Methods of this service will
...
public interface DealerLocalService extends BaseLocalService, PersistedModelLocalService {
	 ...
	 * this interface. Consume the dealer local service via injection or a
	 * <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link
	 * DealerLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Dealer getDealerByUuidAndGroupId(String uuid, long groupId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Dealer> getDealersByUuidAndCompanyId(String uuid, long companyId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Dealer> getDealersByUuidAndCompanyId(String uuid, long companyId, int start, int end,
			OrderByComparator<Dealer> orderByComparator);
