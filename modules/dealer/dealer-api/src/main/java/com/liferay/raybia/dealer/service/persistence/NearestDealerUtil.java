...
public class NearestDealerUtil {
	...
	private static ServiceTracker
		<NearestDealerPersistence, NearestDealerPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(NearestDealerPersistence.class);

		ServiceTracker<NearestDealerPersistence, NearestDealerPersistence>
			serviceTracker =
				new ServiceTracker
					<NearestDealerPersistence, NearestDealerPersistence>(
						bundle.getBundleContext(),
						NearestDealerPersistence.class, null);
