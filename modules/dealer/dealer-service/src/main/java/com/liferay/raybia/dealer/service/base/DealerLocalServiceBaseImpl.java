 ...
 * in {@link com.liferay.raybia.dealer.service.impl.DealerLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class DealerLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * <code>DealerLocalService</code> via injection or a
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Dealer.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return dealerPersistence.findWithDynamicQuery(dynamicQuery, start, end, orderByComparator);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery, Projection projection) {
		...
		return dealerPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(final PortletDataContext portletDataContext) {
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<Dealer>() {

			@Override
			public void performAction(Dealer dealer) throws PortalException {

				StagedModelDataHandlerUtil.exportStagedModel(portletDataContext, dealer);
			}

		});
		exportActionableDynamicQuery
				.setStagedModelType(new StagedModelType(PortalUtil.getClassNameId(Dealer.class.getName())));
	...
	public List<Dealer> getDealersByUuidAndCompanyId(String uuid, long companyId, int start, int end,
		...
		return dealerPersistence.findByUuid_C(uuid, companyId, start, end, orderByComparator);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] { DealerLocalService.class, IdentifiableOSGiService.class,
