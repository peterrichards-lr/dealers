...
/**
 * The arguments resolver class for retrieving value from NearestDealer.
 *
...
@Component(
	immediate = true,
	service = {
		NearestDealerModelArgumentsResolver.class, ArgumentsResolver.class
	}
)
public class NearestDealerModelArgumentsResolver implements ArgumentsResolver {
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				arguments[i] = nearestDealerModelImpl.getColumnOriginalValue(
					columnName);
			}
			else {
