...
import com.liferay.raybia.dealer.model.DealerTable;
...
@Component(
	immediate = true,
	service = {DealerModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class DealerModelArgumentsResolver implements ArgumentsResolver {
	...
	static {
		...
		orderByColumnsBitmask |= DealerModelImpl.getColumnBitmask("name");
